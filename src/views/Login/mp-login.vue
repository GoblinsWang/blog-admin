        ...
        <div class="content__form">
          ...
          <div class="content__form-item">
            <div class="form-item__input">
              ...
              <input v-model="user.password" type="password" id="password" placeholder="请输入密码" autocomplete="off" @keyup.enter="login" />
            </div>
          </div>
        </div>
...
async function login() {
  ...
  // })
  const { status, data } = { status: 200, data: '11' }
  if (status === 200) {
    setUserInfo(data)
